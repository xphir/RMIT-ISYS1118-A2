...
public class ApproverUI extends JFrame implements ActionListener  
{   
        ...
        {  
            ...
            jb2=new JButton("Report Task List");  
            ...
            jlb6=new JLabel(new MainUI().AP_name);
            jlb7=new JLabel(new MainUI().AP_num);
